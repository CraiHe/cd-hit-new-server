...
sub result_left{
  ...
  print $q->start_html(-title=>"You job $JOBID is finished",-bgcolor=>"#EEEEEE", -style=>{-src=>"../dist/css/main.css"});
  print <<EOD;
<table width="100%">
<table align="left" style="border-bottom: 2px solid rgb(164,163,159);" width="100%" bgcolr="#EEEEEE">
<tr>
  <td bgcolor="#EEEEEE" height="80" style="border-bottom: 2px solid rgb(238,238,238);" align="left">
...
sub result_right{
  my $JOBID = shift;
  print $q->header("text/html");
  print $q->start_html(-title=>"You job $JOBID is finished",-bgcolor=>"#EEEEEE");
